...
# Plot histograms of the TWI
plt.figure(2, dpi=100)
plt.hist(twi.flatten(), label="TWI of total area")
plt.hist(twi[twi>numpy.percentile(twi.flatten(), 80)].flatten(), label="TWI of wetland"); plt.yscale("log"); plt.xlabel("Topographic Wetness Index"); plt.legend(); plt.title("Topographic Wetness Index of the wetland area")